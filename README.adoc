= Spring Statemachine is no longer maintained

Please refer to the https://spring.io/blog/2025/04/21/spring-cloud-data-flow-commercial[announcement] for more information.
