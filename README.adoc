...
image:https://build.spring.io/plugins/servlet/buildStatusImage/SDG-B12X[Bamboo Build Status, link=https://build.spring.io/browse/SDG-B12X]
image:https://build.spring.io/plugins/servlet/buildStatusImage/SDG-B11X[Bamboo Build Status, link=https://build.spring.io/browse/SDG-B11X]
