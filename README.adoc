...
=== Prerequisites
https://help.github.com/set-up-git-redirect[Git] and https://www.oracle.com/technetwork/java/javase/downloads[JDK17+].

Be sure that your `JAVA_HOME` environment variable points to the
`jdk` folder extracted from the JDK download. The build requires
`JDK17+`.
